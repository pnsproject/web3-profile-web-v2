<template>
  <div id="BaseInfo">
    <div class="domain" @click="showShare=true">asd.dot</div>
    <div class="des">Welcome to my world.Thank you for your support</div>
    <div class="domain-owner">
      ...
      <div class="wallet">
        <span>0xasd...as</span>
        <CopyText :text="account.address" :show-text="false" />
      </div>
    </div>
    <div class="media-list">
      <SocialMedia type="Github" url="www.jjjjjj.com" />
    </div>
  </div>
