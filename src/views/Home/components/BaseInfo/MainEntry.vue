  ...
  <div id="BaseInfo">
    ...
    <div class="domain-owner">
      <a v-if="twitter" class="twitter" :href="twitter.value" target="_blank">
        ...
        <span>@{{ twitter.value.replace('https://twitter.com/', '') }}</span>
<!--        <img :src="twitterValidIcon" alt="Valid" class="valid-icon" v-if="verifyInfo.twitter">-->
        <img :src="twitterValidIcon" alt="Valid" class="valid-icon">
      </a>
...
import twitterValidIcon from './components/assets/twitter_valid_icon.svg'
